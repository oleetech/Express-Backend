            ...
            schemas: {
                ...
                Product: {
                    ...
                    properties: {
                        ...
                        featureImage: { type: 'boolean', description: 'Whether this is a feature image', example: false },
                        enquery: { type: 'string', description: 'Product enquiry information', example: 'Inquire here' },
