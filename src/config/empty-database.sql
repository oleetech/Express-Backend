...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 14, 2024 at 10:59 AM
...
CREATE TABLE `users` (
  ...
  `otpExpires` timestamp NULL DEFAULT NULL,
...
ALTER TABLE `users`
  ...
  ADD UNIQUE KEY `IDX_f9740e1e654a5daddb82c60bd7` (`facebookId`);
